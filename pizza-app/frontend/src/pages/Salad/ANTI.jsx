...
import ANTIimg from '../../image/ANTI.png';
...
function ANTI() {
    ...
    const initialToppings = [ "Ham", "Salmi", "Mozzarella", "Black Olives", "Tomatoes"]; // Define the initial toppings
    ...
    return (
        <div className='salad-container'>
            ...
            <div className="salad-content">
                <img className="salad-img" src={ANTIimg} alt="ANTIimg"/>
            </div>
