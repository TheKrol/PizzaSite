...
import AMTimg from '../../image/AMT.png'
import { useCartActions } from '../../context/CartContext';
import './Pizza.css'

function AMT() {
    const pizzaVariation = 'Specialty5'; // Fixed variation
    const [showSuccessMessage, setShowSuccessMessage] = useState(false);
    const cartActions = useCartActions(); // Added to access cart manipulation functions
    const navigate = useNavigate();
    const initialToppings = [ "Pepperoni", "Ham", "Bacon", "Sausage", "Beef"]; // Define the initial toppings
    ...
    return (
        <div className="byo-container">
            ...
            <div className="byo-content">
                ...
                <img className="byo-img" src={AMTimg} alt="AMTimg"/>
