...
import GARDENimg from '../../image/GARDEN.png';
...
function ANTI() {
    ...
    const initialToppings = [ "Green Peppers", "Onions", "Cheddar", "Black Olives", "Tomatoes"]; // Define the initial toppings
    ...
    return (
        <div className='salad-container'>
            ...
            <div className="salad-content">
                <img className="salad-img" src={GARDENimg} alt="GARDENimg"/>
            </div>
