...
import ABBQimg from '../../image/ABBQ.png'
import { useCartActions } from '../../context/CartContext';
import './Pizza.css'

function ABBQ() {
    const pizzaVariation = 'Specialty3'; // Fixed variation
    const [showSuccessMessage, setShowSuccessMessage] = useState(false);
    const cartActions = useCartActions(); // Added to access cart manipulation functions
    const navigate = useNavigate();
    const initialToppings = ["Bacon", "Chicken", "Pineapple"]; // Define the initial toppings
    ...
    const [sauce, setSauce] = useState('BBQ');
    ...
    return (
        <div className="byo-container">
            ...
            <div className="byo-content">
                ...
                <img className="byo-img" src={ABBQimg} alt="ABBQimg"/>
